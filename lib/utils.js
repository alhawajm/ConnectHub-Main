...
export function roleHasSubscriptions(role) {
  return role === 'employer'
}

export function getRolePlanMeta(profile = {}) {
  ...
  if (plan === 'platinum') {
    return {
      key: 'platinum',
      label: 'Platinum',
      className: 'bg-[rgba(0,207,253,0.1)] text-[#0099cc] border-[rgba(0,207,253,0.2)]',
      showBilling: true,
    }
  }
